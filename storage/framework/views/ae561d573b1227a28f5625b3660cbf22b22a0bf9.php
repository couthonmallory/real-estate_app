...
<div class="mt-10 mx-8">
    ...
    <center>
        ...
        <?php $__currentLoopData = $transacs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
            <tbody>
                <tr>
                <td class="border border-slate-600 p-4 text-center"><?php echo e($transac->user_id); ?></td>
                <td class="border border-slate-600 p-4 text-center"><?php echo e($transac->properties_id); ?></td>
                <td class="border border-slate-600 p-4 text-center"><?php echo e($transac->created_at); ?></td>
                <td class="border border-slate-600 p-4 text-center">
                    <a href="/show/<?php echo e($transac->properties_id); ?>">
                        <button>
                ...
                <td class="border border-slate-600 p-4 text-center">
                    <a href="/deleteTransac/<?php echo e($transac->id); ?>">
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<?php echo $__env->make('admin_pages.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mallory/Documents/Stages/1st_year/agence_immobiliere/resources/views/admin_pages/transactions.blade.php ENDPATH**/ ?>