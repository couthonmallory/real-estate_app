...
top-<[-400px] transition-all ease-in">
    ...
    <li class="mx-4 my-6 md:my-0 "> 
        <button class="border-orange-500 border-2 rounded-lg p-1 bg-orange-400" >
            <a href="<?php echo e(route('locations')); ?>" class="text-xl text-green-500 hover:underline duration-500"> 
...
<home-page content= "<?php echo e($content); ?>" logo="<?php echo e($logo); ?>" hotel=<?php echo e($hotel); ?>
...
<?php /**PATH /home/mallory/Documents/Stages/1st_year/agence_immobiliere/resources/views/website_pages/home.blade.php ENDPATH**/ ?>