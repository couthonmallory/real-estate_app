...
<center>
    ...
    @foreach ( $users as $user )
        ...
        <tbody>
            <tr>
            <td class="border border-slate-600 p-4 text-center">{{ $user->name }}</td>
            <td class="border border-slate-600 p-4 text-center">{{ $user->email }}</td>
            <td class="border border-slate-600 p-4 text-center">{{ $user->role }}</td>
