<template>
    ...
    <button @click="checkoutHandler(false)" class="py-1 px-1 rounded bg-indigo-600 hover:bg-indigo-700 text-white">Cart()</button>

    <!-- component -->

    <div class="mt-60 bg-black dark:bg-gray-900 bg-opacity-90 top-16 overflow-y-auto overflow-x-hidden  hidden" id="chec-div">
        ...
        <div class="flex items-end lg:flex-row flex-col justify-end" id="cart">
            ...
            <div class="flex items-center text-gray-500 hover:text-gray-600 dark:text-white cursor-pointer" @click="checkoutHandler(false)">
            ...
            <div class="flex flex-col lg:h-screen h-auto lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between overflow-y-auto">
                ...
                <button @click="checkoutHandler1(true)" class="text-base leading-none w-full py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white dark:hover:bg-gray-700">Checkout</button>
                </div>
            </div>
            </div>
        </div>
